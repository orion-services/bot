...
public interface BlocklyClient {
    ...
    public User createUser(@FormParam("name") String name,
            @FormParam("hashUser") String discriminator)
            throws WebApplicationException;
    ...
    @Consumes(MediaType.APPLICATION_FORM_URLENCODED)
    @Produces(MediaType.APPLICATION_JSON)
    Group createGroup(@FormParam("namegroup") String groupName,
            @FormParam("hashUser") String discriminator)
            throws WebApplicationException;
    ...
    @Consumes(MediaType.APPLICATION_FORM_URLENCODED)
    @Produces(MediaType.APPLICATION_JSON)
    Group joinGroup(@FormParam("hashUser") String discriminator,
            @FormParam("namegroup") String groupName)
            throws WebApplicationException;
    ...
    @Consumes(MediaType.APPLICATION_FORM_URLENCODED)
    @Produces(MediaType.APPLICATION_JSON)
    Activity createActivity(@FormParam("namegroup") String groupName)
            throws WebApplicationException;
    ...
    String participates(@FormParam("hashUser") String discriminator,
            @FormParam("namegroup") String groupName)
            throws WebApplicationException;
    ...
    @Consumes(MediaType.APPLICATION_FORM_URLENCODED)
    @Produces(MediaType.APPLICATION_JSON)
    Activity checkStatus(@FormParam("alias") String alias);
